### HOW TO RUN ### 
Note this is a gcc/g++ build using CMake and make, and requires R if you would like to compile the paper as well.
...
1) *Make sure all the dependencies have been installed (including MSYS Makefiles for Win and make for Linux)
2) $ bash knit.sh -r
	options:
